...
st.markdown("This application is a streamlit dashboard that can be used analyze motor vehicle collisions in NYC ")
...
injured_people = st.slider("Number of persons injured during vehicle collision", 0, 19)
